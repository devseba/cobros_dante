...
=======
					$cl = array(date('Y')-1 => date('Y')-1, date('Y') => date('Y'), (date('Y')+1) => (date('Y')+1), (date('Y')+2) => (date('Y')+2), (date('Y')+3) => (date('Y')+3));
>>>>>>> .r165
				?>
	...
	<button class="button" type="submit" id="serialize">Mover a división</button>
	<?=form_close()?>
</div>
