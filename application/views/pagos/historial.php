...
<div class="pad">
	<h2>Historial de pagos para <?php echo $a->nombre.' '.$a->apellido ?> <?php echo anchor($this->agent->referrer(),img('static/img/icon/arrow_left.png').' Volver atrás')?></h2>
	<!--<div id="filtros">
		<form action="" method="post" id="f">
			<?=img('static/img/icon/zoom.png')?>
			<?=form_input(array('name' => 'string', 'class' => 'tipns', 'title' => 'Nombre, apellido o DNI'))?>
			<div class="selects"><?=anchor('#',img('static/img/icon/delete.png'),'id="clean"')?>
			</div>
		</form>
	</div>-->
	<div id="results">
