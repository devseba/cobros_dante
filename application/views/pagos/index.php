<div class="pad">
	<h2>Listado de pagos <span><?=anchor('pagos/export',img('static/img/icon/doc_export.png'),'id=export')?><?=anchor('pagos/reporte',img('static/img/icon/print.png'),'id=print')?></span></h2>
	<div id="filtros">
		<form action="" method="post" id="f">
			...
			<div class="selects">
				...
				<?
					$pt = array();
					$pt[0] = 'Todos';
					foreach($tipos_pagos as $t) $pt[$t->id] = $t->tipo;
					echo form_dropdown('ptype_id',$pt,isset($filtros['ptype_id']) ? $filtros['ptype_id'] : set_value('ptype_id'),'id="ptype_id" class="tipns" title="Filtrar por Tipo Pago"')
				?>
